      ...
      <div class="min-h-screen flex flex-col dark:bg-gray-950">
        ...
        <nav class="bg-white dark:bg-gray-950 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
            ...
            <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
                ...
                <li>
                    <a href="/recommended" class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500" aria-current="page">Recommended</a>
                </li>
                <li>
