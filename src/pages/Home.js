...
function Home() {
  ...
  return (
      <div class="min-h-screen flex flex-col dark:bg-gray-950">
            ...
            <nav class="bg-white dark:bg-gray-950 fixed w-full z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="/" class="flex items-center">
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">BLOGLY™</span>
            </a>
            <div class="flex md:order-2">
            <div class="flex-shrink-0 group block">
            <div class="flex items-center">
                <img class="inline-block flex-shrink-0 h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1568602471122-7832951cc4c5?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=facearea&facepad=2&w=300&h=300&q=80" alt="Image Description" />
                <div class="ml-3">
            ...
            <section class="bg-center bg-no-repeat bg-main bg-cover bg-slate-300 bg-blend-multiply">
                <div class="px-4 min-h-screen mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                    ...
                    <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
                        ...
                        <a href="/search" class="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
                            Explore
                        </a>  
                    </div>
                </div>
            ...
            <div className='min-h-screen flex flex-col justify-center items-center bg-img1 bg-no-repeat bg-fixed bg-seal bg-cover bg-center'>
                <div className='h-full w-1/2 bg-gray-400 rounded-md bg-clip-padding background-filter backdrop-blur-sm bg-opacity-20 p-10'>
                    ...
                    <p className="w-full text-center text-2xl pt-2 pb-2 mt-2 text-white dark:text-black">
            ...
            <div className='bg-img6 min-h-screen flex justify-center items-center bg-center bg-no-repeat bg-cover bg-fixed'>
                  <div className='h-full w-1/2 bg-gray-400 rounded-md bg-clip-padding background-filter backdrop-blur-sm bg-opacity-20 p-10'>
                        <h1 className='text-white dark:text-black  text-5xl text-center'> ANNOUNCEMENTS </h1>
                        <p className="w-full text-center text-2xl pt-2 pb-2 mt-2 text-white dark:text-black">
                        “Awesome place to make oneself productive and entertained through daily updates.”
                        </p>
                        <div className="flex justify-center">
            ...
            <div className='bg-img5 min-h-screen flex justify-center items-center bg-center bg-no-repeat bg-fit bg-fixed'>
                  <div className='h-full w-1/2 bg-gray-400 rounded-md bg-clip-padding background-filter backdrop-blur-sm bg-opacity-50 dark:bg-opacity-20 p-10'>
                        ...
                        <p className="w-full text-center text-2xl pt-2 pb-2 mt-2 text-black dark:text-white">
                        “Awesome place to make oneself productive and entertained through daily updates.”
                        </p>
                        <div className="flex justify-center">
                            <Link to="/recommended">
...
<footer class="bg-white dark:bg-gray-900">
    ...
    <div class="px-4 py-6 bg-gray-100 dark:bg-gray-700 md:flex md:items-center md:justify-between">
        <span class="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a href="/">BLOGLY™</a>. All Rights Reserved.
        </span>
